...
namespace Disruptor
{
    ...
    public sealed class SingleThreadedClaimStrategy : IClaimStrategy
    {
        ...
        private Volatile4.PaddedLong _claimSequence = new Volatile4.PaddedLong(Sequencer.InitialCursorValue);
        private Volatile4.PaddedLong _minGatingSequence = new Volatile4.PaddedLong(Sequencer.InitialCursorValue);
