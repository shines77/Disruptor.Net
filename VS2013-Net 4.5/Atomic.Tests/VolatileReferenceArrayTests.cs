...
namespace Atomic.Tests
{
    ...
    {
        private Volatile4.ReferenceArray<ClassStub> _volatile;
        ...
        public void SetUp()
        {
            _volatile = new Volatile4.ReferenceArray<ClassStub>(InitialValues);
        }
        ...
        {
            const int length = 2;
            _volatile = new Volatile4.ReferenceArray<ClassStub>(length);
