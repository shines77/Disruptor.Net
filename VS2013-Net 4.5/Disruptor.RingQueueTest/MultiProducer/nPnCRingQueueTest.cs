...
namespace Disruptor.RingQueueTest
{
    class nPnCRingQueueTest
    {
        ...
        private static Volatile4.PaddedLong[] _counters = new Volatile4.PaddedLong[POP_CNT];

        public static Volatile4.PaddedLong _remainCount = new Volatile4.PaddedLong(MAX_MSG_COUNT);
    ...
    //struct MessageEvent
    {
        ...
        /*
        private Volatile4.PaddedLong valueLong;
        public long Value {
